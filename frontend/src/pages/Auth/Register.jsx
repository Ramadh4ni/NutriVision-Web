      ...
      <div className="w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <div className="relative py-4 sm:py-5">
            ...
            <div className="relative flex justify-center"><span className="px-4 sm:px-5 bg-white text-xs font-semibold uppercase tracking-wider" style={{ color: '#64748B', fontFamily: 'Inter' }}>Or Login With</span></div>
          </div>

          <button type="button" className="w-full py-3.5 sm:py-4 text-sm sm:text-base font-medium rounded-full transition-colors flex items-center justify-center gap-2 sm:gap-3"
          ...
          <button type="button" className="w-full py-3.5 sm:py-4 text-sm sm:text-base font-medium rounded-full transition-colors flex items-center justify-center gap-2 sm:gap-3"
            style={{ backgroundColor: '#F8FAFC', color: '#1E293B', fontFamily: 'Inter' }}>
            <img src={AppleIcon} alt="Apple" className="w-4 h-4 sm:w-5 sm:h-5 object-contain" />
            Continue with Apple
          </button>
        </form>
